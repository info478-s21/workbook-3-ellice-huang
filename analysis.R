...
# The graph shows that life expectancy is increasing more than healthy life
# expectancy. The change in life expectancy is greater than the change in HALE.
# I think this means that as people live longer, it does not mean that they live
# healthier lives.